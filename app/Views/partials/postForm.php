...
<div class="p-4 pb-2 postForm-wrap d-md-block d-none">
    <div class="row justify-content-center">
        ...
        <div class="col-md-11">
            <textarea placeholder="O que está acontecendo?" maxlength="150" rows='1' name="postInput" oninput="autoGrow(this); countCharacters(this);"></textarea>
            <div class="text-end">
                <p id="charCount"></p>
                <p class="text-danger">
                    <?php if (!empty($post_erros)): ?>
                        <?php foreach ($post_erros as $post_erro): ?>
                            <?= $post_erro ?>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </p>
            ...
            <div class="modal-body">
                <div class="p-4 pb-2 postForm-wrap">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-10">
                            <textarea placeholder="O que está acontecendo?" maxlength="150" rows='3' name="postInput" oninput="autoGrow(this); countCharacters(this);"></textarea>
                            <div class="text-end">
                                <p id="charCount"></p>
